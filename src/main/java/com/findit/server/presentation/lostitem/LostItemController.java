package com.findit.server.presentation.lostitem;
...
import com.findit.server.application.lostitem.LostItemApplicationService;
...
public class LostItemController {
    ...
    private final LostItemApplicationService lostItemService;
    ...
    public ResponseEntity<ApiResponse<List<LostItemDto>>> getAllLostItems(
    ...
    public ResponseEntity<ApiResponse<LostItemDto>> createLostItem(
        ...
        return ResponseEntity.status(HttpStatus.CREATED)
                .body(ApiResponse.success("Lost item created successfully", createdLostItem));
    }
    ...
    public ResponseEntity<ApiResponse<List<LostItemDto>>> findByPrdtClNm(
    ...
    public ResponseEntity<ApiResponse<List<LostItemDto>>> findByLstPlace(
    ...
    public ResponseEntity<ApiResponse<List<LostItemDto>>> searchByKeyword(
    ...
    public ResponseEntity<ApiResponse<List<LostItemDto>>> findRecentLostItems(
    ...
    public ResponseEntity<ApiResponse<List<LostItemDto>>> findByLstYmdRange(
