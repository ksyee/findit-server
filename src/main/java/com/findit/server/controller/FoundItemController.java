...
public class FoundItemController {
    ...
    @ApiResponses(value = {
        @io.swagger.v3.oas.annotations.responses.ApiResponse(responseCode = "200", description = "조회 성공", content = @Content(schema = @Schema(implementation = com.findit.server.dto.ApiResponse.class))),
        @io.swagger.v3.oas.annotations.responses.ApiResponse(responseCode = "500", description = "서버 오류")
    })
    public ResponseEntity<com.findit.server.dto.ApiResponse<List<FoundItemDto>>> getAllFoundItems(
        ...
        com.findit.server.dto.ApiResponse<List<FoundItemDto>> response = com.findit.server.dto.ApiResponse.success(foundItems);
    ...
    public ResponseEntity<com.findit.server.dto.ApiResponse<FoundItemDto>> getFoundItemByAtcId(
        ...
        try {
            ...
            return ResponseEntity.ok(com.findit.server.dto.ApiResponse.success(foundItem));
    ...
    @ApiResponses(value = {
        @io.swagger.v3.oas.annotations.responses.ApiResponse(responseCode = "201", description = "등록 성공", content = @Content(schema = @Schema(implementation = com.findit.server.dto.ApiResponse.class))),
        @io.swagger.v3.oas.annotations.responses.ApiResponse(responseCode = "400", description = "잘못된 요청"),
        @io.swagger.v3.oas.annotations.responses.ApiResponse(responseCode = "500", description = "서버 오류")
    })
    public ResponseEntity<com.findit.server.dto.ApiResponse<FoundItemDto>> createFoundItem(
        ...
        return ResponseEntity.status(HttpStatus.CREATED)
                .body(com.findit.server.dto.ApiResponse.success("등록 성공", createdFoundItem));
    }
    
    @PutMapping("/{atcId}")
    @Operation(summary = "습득물 수정", description = "특정 atcId의 습득물을 수정합니다.")
    @ApiResponses(value = {
        @io.swagger.v3.oas.annotations.responses.ApiResponse(responseCode = "200", description = "수정 성공", content = @Content(schema = @Schema(implementation = com.findit.server.dto.ApiResponse.class))),
        @io.swagger.v3.oas.annotations.responses.ApiResponse(responseCode = "404", description = "습득물을 찾을 수 없음"),
        @io.swagger.v3.oas.annotations.responses.ApiResponse(responseCode = "400", description = "잘못된 요청"),
        @io.swagger.v3.oas.annotations.responses.ApiResponse(responseCode = "500", description = "서버 오류")
    })
    public ResponseEntity<com.findit.server.dto.ApiResponse<FoundItemDto>> updateFoundItem(
            @Parameter(description = "습득물 관리 ID (ATC_ID)", required = true) @PathVariable String atcId,
        ...
        try {
            ...
            return ResponseEntity.ok(com.findit.server.dto.ApiResponse.success("수정 성공", updatedFoundItem));
        } catch (RuntimeException e) {
            return ResponseEntity.status(HttpStatus.NOT_FOUND)
                    .body(com.findit.server.dto.ApiResponse.error(e.getMessage()));
        }
    ...
    @ApiResponses(value = {
        @io.swagger.v3.oas.annotations.responses.ApiResponse(responseCode = "200", description = "삭제 성공", content = @Content(schema = @Schema(implementation = com.findit.server.dto.ApiResponse.class))),
        @io.swagger.v3.oas.annotations.responses.ApiResponse(responseCode = "404", description = "습득물을 찾을 수 없음"),
        @io.swagger.v3.oas.annotations.responses.ApiResponse(responseCode = "500", description = "서버 오류")
    })
    public ResponseEntity<com.findit.server.dto.ApiResponse<Void>> deleteFoundItem(
            @Parameter(description = "습득물 관리 ID (ATC_ID)", required = true) @PathVariable String atcId) {
        try {
            foundItemService.deleteFoundItem(atcId);
            return ResponseEntity.ok(com.findit.server.dto.ApiResponse.success("삭제 성공", null));
        } catch (RuntimeException e) {
            return ResponseEntity.status(HttpStatus.NOT_FOUND)
                    .body(com.findit.server.dto.ApiResponse.error(e.getMessage()));
        }
    ...
    public ResponseEntity<com.findit.server.dto.ApiResponse<List<FoundItemDto>>> findByItemType(
    ...
    public ResponseEntity<com.findit.server.dto.ApiResponse<List<FoundItemDto>>> findByLocation(
    ...
    public ResponseEntity<com.findit.server.dto.ApiResponse<List<FoundItemDto>>> searchByKeyword(
    ...
    public ResponseEntity<com.findit.server.dto.ApiResponse<List<FoundItemDto>>> findRecentFoundItems(
    ...
    public ResponseEntity<com.findit.server.dto.ApiResponse<List<FoundItemDto>>> findByDateRange(
