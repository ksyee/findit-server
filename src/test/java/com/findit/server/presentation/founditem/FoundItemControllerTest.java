...
import com.findit.server.config.TestMeterRegistryConfig;
...
public class FoundItemControllerTest {
    ...
    static class ServiceMockConfig {
        @Bean
        public FoundItemApplicationService foundItemService() {
            return Mockito.mock(FoundItemApplicationService.class);
        }
    ...
    @Autowired
    private FoundItemApplicationService foundItemService;
